...
public class AthLargestElement {
    ...
    public ArrayList<Integer> solve(int A, ArrayList<Integer> list) {
        ArrayList<Integer> ans = new ArrayList<>(Arrays.asList(new Integer[list.size()]));
    ...
    public static void main(String[] args) {
        System.out.println(new AthLargestElement().solve(4, new ArrayList<Integer>(Arrays.asList(1, 2, 3, 4, 5, 6))));
    }
}
