 ...
 *
 *
 * Related Topics Hash Table String Design 👍 2708 👎 122
 */
...
class DesignUndergroundSystem {
    public static void main(String args[]) {
        UndergroundSystem solution = new DesignUndergroundSystem().new UndergroundSystem();
    }
    ...
    class UndergroundSystem {
        ...
        private HashMap<Pair<String, String>, ArrayList<Integer>> checkedOutTimings;

        public UndergroundSystem() {
            checkInMap = new HashMap<>();
            checkedOutTimings = new HashMap<>();
        ...
        public void checkOut(int id, String stationName, int t) {
            ...
            if (!checkedOutTimings.containsKey(new Pair<String, String>(checkInPair.getKey(), stationName))) {
                checkedOutTimings.put(new Pair<String, String>(checkInPair.getKey(), stationName), new ArrayList<Integer>());
            }
            checkedOutTimings.get(new Pair<String, String>(checkInPair.getKey(), stationName)).add(t - checkInPair.getValue());
        }

        public double getAverageTime(String startStation, String endStation) {
            double sum = 0;
            ArrayList<Integer> list = checkedOutTimings.get(new Pair<String, String>(startStation, endStation));
