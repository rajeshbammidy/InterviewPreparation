 ...
 *
 *
 * Related Topics Hash Table Depth-First Search Breadth-First Search Graph 👍 7955
 * 👎 3231
 */
    ...
    class Solution {
        public Node cloneGraph(Node node) {
            ...
            while (!queue.isEmpty()) {
                ...
                Node dummyNode = map.get(currNode.val);
                if (dummyNode == null) {
                    dummyNode = new Node(currNode.val);
                    map.put(currNode.val, dummyNode);
                }
                for (Node n : currNode.neighbors) {
                    ...
                    dummyNode.neighbors.add(map.get(n.val));
                }
            }
