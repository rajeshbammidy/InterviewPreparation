 ...
 *
 *
 * Related Topics Array Dynamic Programming 👍 5434 👎 93
 */
...
class Solution983 {
    ...
    private int getMinCost(int start, int end, int days[], int[] costs) {
        ...
        /**
         * If it is one day pass, go for the next day
         */

        int oneDayPass = costs[0] + getMinCost(start + 1, end, days, costs);
        /**
         * Add 6 days to the current day at start, to add the cost of 7 days
         */
        ...
        /**
         * Add 29 days to the current day at start, to add the cost of 30 days
         */
