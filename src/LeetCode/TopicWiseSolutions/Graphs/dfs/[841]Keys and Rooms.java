 ...
 *
 *
 * Related Topics Depth-First Search Breadth-First Search Graph 👍 5004 👎 232
 */
...
class Solution841 {
    ...
    private void dfs(List<List<Integer>> rooms, int i, HashSet<Integer> hashSet) {

        hashSet.add(i);
        for (int key : rooms.get(i)) {
            if (!hashSet.contains(key)) {
                dfs(rooms, key, hashSet);
            }
        }
    }
}
